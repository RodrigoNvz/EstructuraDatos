...
public class LinkedList<E> implements List<E> {
	...
	public E josephus(int pasos) {
		...
		while(size!=1) {
			...
			if(bandera==0) {
				System.out.println("Debe morir: "+verdugo.prev.value );
				remove(verdugo.prev.value);
			}else {
				System.out.println("Debe morir: "+verdugo.prev.prev.value );
				remove(verdugo.prev.prev.value);
			}
			
			System.out.println("Sobreviven: \n"+toString());
		}
		
		return verdugo.value;
